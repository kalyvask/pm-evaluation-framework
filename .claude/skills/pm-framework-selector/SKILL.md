...
| How do I design a product that acts on the user's behalf (agent attribution, transparency, approval gates, autonomy)? | `decision-making/agentic-product-design.md` |
