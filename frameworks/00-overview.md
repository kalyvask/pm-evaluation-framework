...
|---|---|---|
| 1. [Strategy & Discovery](01-strategy-and-discovery.md) | Define the *why* for PMF | PMF Narrative · Working Backwards · Pre-Mortem · Execution Risk Matrix · One-Way / Two-Way Doors |
| 2. [Defining the MVP](02-defining-the-mvp.md) | Scope the minimal path to *aha* | JTBD Ranking · MoSCoW · Kano · Story Mapping · Cupcake Model |
| 3. [Pre-PMF Validation](03-pre-pmf-validation.md) | Find signal to scale | "10 Happy Users" · Sean Ellis Test · Activation Rate / TTV · GTM Strategy Checklist · Smile Curve · ARC PMF Framework |
