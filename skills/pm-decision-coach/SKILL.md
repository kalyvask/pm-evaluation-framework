...
Reference: `${CLAUDE_PLUGIN_ROOT}/decision-making/problem-framing.md`.
...
Reference: `${CLAUDE_PLUGIN_ROOT}/decision-making/problem-framing.md` ("What would have to be true?").
...
Reference: `${CLAUDE_PLUGIN_ROOT}/decision-making/risk-and-reversibility.md`.
...
For prioritization decisions: `${CLAUDE_PLUGIN_ROOT}/decision-making/prioritization.md` and `${CLAUDE_PLUGIN_ROOT}/frameworks/05-continuous-prioritization.md`.
For validation decisions: `${CLAUDE_PLUGIN_ROOT}/frameworks/03-pre-pmf-validation.md`.
For metrics decisions: `${CLAUDE_PLUGIN_ROOT}/decision-making/metrics.md`.
For research decisions: `${CLAUDE_PLUGIN_ROOT}/decision-making/research-methods.md`.
...
Reference: `${CLAUDE_PLUGIN_ROOT}/cross-functional/failure-management.md`.
