...
Grades a PM artifact against the five-criterion rubric in `${CLAUDE_PLUGIN_ROOT}/rubrics/pm-evaluation-rubric.md`. Designed to give honest, specific, actionable critique — not a hagiographic review.
...
Full criterion-by-criterion scoring guidance: `${CLAUDE_PLUGIN_ROOT}/rubrics/pm-evaluation-rubric.md`.

For strategy memos specifically: `${CLAUDE_PLUGIN_ROOT}/rubrics/strategy-memo-rubric.md`.
For live product review participation: `${CLAUDE_PLUGIN_ROOT}/rubrics/product-review-rubric.md`.
